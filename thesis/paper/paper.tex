...
%-------------------
\begin{acknowledge}
I would like to express my deepest gratitude to my supervisor, Professor Akihiro Nakao, for his continuous guidance since my senior year of undergraduate studies. Professor Nakao generously made time for weekly meetings despite his busy schedule, providing thoughtful feedback drawn from his deep expertise. Beyond guiding my research direction, these regular discussions helped me maintain consistent momentum for my work. His support throughout this journey has been encouraging, and I have always admired how hard he works, which motivates me to push myself as well.

My appreciation also goes to the faculty members and staff of the Nakao Laboratory for their support, as well as my fellow lab members for their help and discussions.

I am grateful to Professor Fabrizio Granelli at the University of Trento, where I conducted research as an exchange student upon Professor Nakao's recommendation. Professor Granelli's feedback, along with his help in arranging hardware and organizing experiments, made it possible for me to achieve results within a short period.

Finally, I am thankful to my family and friends, and especially to Margaux for her daily support and encouragement throughout my studies.
\end{acknowledge}
...
\paragraph{Anchor Geometry and Placement}
Our simulations use grid-constrained anchor placement without optimizing placement strategy.
Real deployments may be constrained by terrain accessibility, and strategic positioning could improve accuracy over the uniform placements evaluated here.
A relevant scenario is placing anchors only around the perimeter of a GNSS-denied region, which differs from our uniform coverage assumption.
Placement optimization for such boundary-constrained deployments remains a direction for future work.
...
\paragraph{Computational Cost and Location Dependency}
The proposed method requires terrain-specific training data generated through propagation simulation, which becomes computationally expensive for large areas and networks with many beacons, though parallelization can substantially reduce this overhead.
A more fundamental limitation is that deploying in a new region requires regenerating training data and retraining the model, as the learned propagation characteristics do not transfer directly.
Future work should explore developing a foundation model pre-trained on diverse terrain conditions, which could then be fine-tuned for new deployment environments with minimal additional data.
That said, physical beacon deployment (site access, installation) is likely the dominant practical bottleneck rather than computational cost.
