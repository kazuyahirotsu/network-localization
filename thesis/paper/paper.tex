...
Finally, I am thankful to my family and friends, and especially to my partner, Margaux, for her daily support and encouragement throughout my studies.
\end{acknowledge}
...
Unlike the client-side problem where beacon positions are given, here we must infer beacon positions from pairwise RSSI measurements within the beacon network, with only a subset of nodes having known coordinates.
