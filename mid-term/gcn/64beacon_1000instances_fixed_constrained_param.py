...
Pt = Parameter(torch.tensor(13.0, requires_grad=True, device=device))
...
#######################################
save_path = 'trained_localization_model_64beacons_1000instances_fixed_constrained_param.pth'
torch.save({
