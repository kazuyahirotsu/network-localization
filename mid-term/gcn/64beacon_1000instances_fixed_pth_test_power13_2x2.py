...
#######################################
load_path = 'trained_localization_model_64beacons_1000instances_fixed_power13_2x2.pth'
...
for instance_idx in tqdm(range(1, num_instances + 1), desc="Loading MATLAB data for testing"):
    filename = f"../../matlab/data/64beacons_1000instances_2x2/data_instance_{instance_idx}.mat"
